    ...
    <div v-show="showFlag" class="food" ref="food">
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <ratingselect :select-type="selectType" :onlyContent="onlyContent" :desc="desc" :ratings="food.ratings"
                        @content-toggle="toggleContent" @ratingtype-select="ratingTypeSelect"></ratingselect>
          <div class="rating-wrapper">
            <ul v-show="food.ratings && food.ratings.length">
              <li v-show="needShow(rating.rateType, rating.text)" v-for="(rating, index) in food.ratings"
                  class="rating-item border-bottom-1px" :key="index">
                <div class="user">
