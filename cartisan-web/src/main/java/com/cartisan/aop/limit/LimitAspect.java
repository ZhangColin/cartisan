...
import static com.cartisan.util.IpUtil.getIpFromRequest;
import static com.cartisan.util.RequestHolder.getHttpServletRequest;
...
public class LimitAspect {
    ...
    @Pointcut("@annotation(com.cartisan.aop.limit.Limit)")
