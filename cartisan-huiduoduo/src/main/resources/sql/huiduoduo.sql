...
CREATE TABLE `cpn_weixin_users` (
  ...
  `language` varchar(32) NULL COMMENT '国家',
  `country` varchar(32) NULL COMMENT '国家',
  `province` varchar(32) NULL COMMENT '省',
  `city` varchar(64) NULL COMMENT '城市',
  `gender` tinyint NULL COMMENT '性别',
  `avatar_url` varchar(255) NULL DEFAULT '' COMMENT '头像',
  `referrer_id` bigint NULL DEFAULT 0 COMMENT '推荐人Id',
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `cpn_coupon_schemas` (
  ...
  `code_image` varchar(255) NOT NULL DEFAULT '' COMMENT '条形码/二维码图片',
...
CREATE TABLE `cpn_coupons` (
  ...
  `code_image` varchar(255) NOT NULL DEFAULT '' COMMENT '条形码/二维码图片',
  `get_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '领取日期',
